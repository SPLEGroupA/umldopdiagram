...
public class ProdukFactory {
	 private static final Logger LOGGER = Logger.getLogger(ProdukFactory.class.getName());

	public ProdukFactory() {}

	 public static Produk createProduk(String fullyQualifiedName, Object ... base)
    {
        Produk record = null;
		try {
            ...
            for (int i = 0; i < constructorList.length; i++) {
              try {
            	...
            	record = (Produk) constructor.newInstance(base);
            ...
            LOGGER.severe("Failed to create instance of Produk.");
