...
public class ProdukServiceImpl extends ProdukServiceDecorator {
    public ProdukServiceImpl (ProdukServiceComponent record) {
 	...
 	public Produk createProduk(Map<String, Object> requestBody){
		...
		Produk katalogprodukkatalogprodukpreowneddeco = ProdukFactory.createProduk("tokoonlineanimepl.katalogproduk.katalogprodukpreowned", katalogprodukkatalogprodukpreowned, id_produk, nama, harga, kategori, deskripsi, stok, gambar_url, kondisi);
	...
	public Produk createProduk(Map<String, Object> requestBody, int id){
		...
		Produk katalogprodukkatalogprodukpreowned = ProdukFactory.createProduk("tokoonlineanimepl.katalogproduk.katalogprodukpreowned.model.ProdukImpl", Produk, id_produk, nama, harga, kategori, deskripsi, stok, gambar_url, kondisi);
